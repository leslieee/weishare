...
$disallowed_extensions = ['php','js'];  // must be an array. Extensions disallowed to be uploaded

$hidden_extensions = ['php','js']; // must be an array of lowercase file extensions. Extensions hidden in directory index
...
<?php endif; ?>
	...
	function renderFileRow(data) {
		var $link = $('<a class="name" />')
			.attr('href', data.is_dir ? '#' + data.path : '/upload/'+data.path)
			.text(data.name);
